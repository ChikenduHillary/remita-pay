...
import { InvoiceDetails as InvoiceDetailsType } from '../types';
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">Review payment information</p>
            </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            <div>
              ...
              <p className="text-xl font-mono font-bold text-gray-900">{invoice.rrr}</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border border-gray-200 rounded-xl">
              <div className="flex items-center mb-2">
                ...
                <p className="text-sm text-gray-600">Amount (NGN)</p>
              </div>
            ...
            <div className="p-4 border border-gray-200 rounded-xl bg-blue-50">
              <div className="flex items-center mb-2">
                ...
                <p className="text-sm text-blue-600">Equivalent (USDC)</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border border-gray-200 rounded-xl">
              ...
              <p className="text-gray-900 font-medium">{invoice.payerName}</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-xl">
              <div className="flex items-center mb-2">
              ...
              <p className="text-gray-900 font-mono">{invoice.merchantId}</p>
            </div>
          </div>
