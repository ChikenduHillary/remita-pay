...
import { InvoiceDetails, PaymentReference } from "../types";
import {
  createSolanaPayQR,
...
export const SolanaPayment: React.FC<SolanaPaymentProps> = ({
  ...
  const generateQRCode = async (retryCount = 0) => {
    try {
      setError("");
      console.log("Generating QR code, attempt:", retryCount + 1);

      const reference = generatePaymentReference();
      setPaymentReference(reference);

      // Ensure amount is a Decimal before passing to createSolanaPayQR
      const { default: Decimal } = await import("decimal.js");
      const decimalAmount = new Decimal(invoice.amount);
      ...
      console.log(
        ...
        "Type:",
        typeof decimalAmount
      );
      console.log("Decimal methods:", {
        toNumber: typeof decimalAmount.toNumber,
        decimalPlaces: typeof decimalAmount.decimalPlaces,
      });

      const qrData = await createSolanaPayQR(
        decimalAmount,
        reference,
        `Remita Invoice Payment - RRR: ${invoice.rrr}`
      );

      console.log("QR code generated successfully, length:", qrData.length);
      ...
      console.error("QR Generation Error (attempt", retryCount + 1, "):", err);
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold mb-1">Solana Payment</h2>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center space-x-2 text-blue-600">
                ...
                <p className="font-semibold">Scan with your Solana wallet</p>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-blue-700">Amount (NGN):</span>
                  <span className="font-bold text-blue-900">
                    ₦{invoice.amount.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-700">Amount (USDC):</span>
                  <span className="font-bold text-blue-900">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-blue-900">USDC</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
              ...
              <ol className="list-decimal list-inside space-y-2 text-yellow-800">
                ...
                <li>Review the payment details in your wallet</li>
                <li>Confirm the transaction</li>
                <li>Click "I have sent the payment" to verify</li>
              </ol>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono font-bold">{invoice.rrr}</span>
                </div>
                <div className="flex justify-between">
